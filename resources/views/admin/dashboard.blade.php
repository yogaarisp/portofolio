...
<div class="space-y-12">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h2 class="text-3xl font-black text-slate-900 tracking-tight leading-tight uppercase">Dashboard <span class="text-primary-600">Utama</span></h2>
        ...
        <div class="flex items-center gap-3">
            <button class="bg-white border border-slate-100 text-slate-600 px-6 py-3.5 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm">Ekspor Laporan</button>
            <a href="{{ route('admin.projects') }}" class="bg-primary-600 text-white px-6 py-3.5 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-primary-700 transition-all shadow-xl shadow-primary-600/20 text-center no-underline flex items-center justify-center">Tambah Proyek</a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
        ...
        <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-500">
            <div class="relative z-10">
                <div class="bg-gradient-to-tr {{ $stat['gradient'] }} w-14 h-14 rounded-2xl flex items-center justify-center text-white shadow-lg mb-6 group-hover:scale-110 transition-transform duration-500">
                ...
                <p class="text-[0.65rem] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">{{ $stat['label'] }}</p>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-10">
        ...
        <div class="xl:col-span-2 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col">
            <div class="px-10 py-8 border-b border-slate-50 flex items-center justify-between">
                <div>
                    <h3 class="font-black text-slate-900 text-xl tracking-tight uppercase">Daftar Proyek <span class="text-primary-600">Terbaru</span></h3>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-slate-50/50">
                        <tr>
                            <th class="px-10 py-5 text-[0.65rem] font-black text-slate-400 uppercase tracking-[0.2em]">Info Proyek</th>
                            <th class="px-10 py-5 text-[0.65rem] font-black text-slate-400 uppercase tracking-[0.2em]">Teknologi</th>
                            <th class="px-10 py-5 text-[0.65rem] font-black text-slate-400 uppercase tracking-[0.2em]">Status</th>
                            <th class="px-10 py-5 text-[0.65rem] font-black text-slate-400 uppercase tracking-[0.2em]">Aksi</th>
                        </tr>
                    </thead>
            ...
            <div class="p-8 border-t border-slate-50 mt-auto flex justify-center">
        ...
        <div class="space-y-10">
            ...
            <div class="bg-gradient-to-br from-slate-900 to-slate-800 p-10 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden group">
                <div class="relative z-10">
                    ...
                    <h3 class="text-2xl font-black tracking-tight leading-tight uppercase mb-4">Proyek <span class="text-primary-500">Baru?</span></h3>
